...
// import { VideoRecorderPlugin } from './definitions';
...
// 		return Promise.resolve();
// 	}
// 	async changeCameraView(): Promise<any> {
// 		if (this.pipActive) {
// 			this.videoElement.style.cssText = this.backgroundStyle;
// 		}
// 		else {
...
// 		return Promise.resolve();
// 	}
// 	async flipCamera(): Promise<any> {
// 		return Promise.resolve();
// 	}
// }

// const CAPVideoRecorder = new VideoRecorderWeb();

// export { CAPVideoRecorder };

// registerWebPlugin(CAPVideoRecorder);
